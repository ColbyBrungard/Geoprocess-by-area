...
2. download the latest SagaGIS? from: https://sourceforge.net/projects/saga-gis/files/ (this code tested with Saga 6.0.2_x64) 
...
1.  el smoothed and filled elevation
2.  hs Hillshade 
3.  sl Slope
...
D. Slope and flow line curvature calculated using the D-inf (Tarboton), slope is in percent. Profile, plan, longitudinal, cross, minimum, maximum, and total curvature calculated using Zevenbergen and Thorne 1987 method.  
...
M. Negative topographic openness: This calculates openness as if viewed from below the land surface, which I didn't find particularly useful (see fig. 5 in Yokoyama et al., 2005). Also, this had significant edge contamination when using larger search radii. 
