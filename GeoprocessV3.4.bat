  ...
  saga_cmd ta_lighting 0 -ELEVATION=%%i\%%i_s.sgrd -SHADE=%%i\%%i_hsA.sgrd -METHOD=0 -UNIT=1
	...
	for %%i in (%tiles%) do (
	 echo now trimming analytical hillshade of %fieldname% %%i
	 	gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_hsA.sdat %%i\%%i_hs.tif
	)   
  ...
  saga_cmd ta_morphometry 0 -ELEVATION=%%i\%%i_s.sgrd -C_PROF=%%i\%%i_profcA.sgrd -C_PLAN=%%i\%%i_plancA.sgrd -C_LONG=%%i\%%i_lcA.sgrd -C_CROS=%%i\%%i_ccA.sgrd -C_MINI=%%i\%%i_mcA.sgrd  -C_MAXI=%%i\%%i_mxcA.sgrd -C_TOTA=%%i\%%i_tcA.sgrd -METHOD=6 -UNIT_SLOPE=2
	...
	for %%i in (%tiles%) do (
	 echo now trimming Profile Curvature of %fieldname% %%i
	  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_profcA.sdat %%i\%%i_profc.tif
	)   
	...
	for %%i in (%tiles%) do (
	 echo now trimming Plan Curvature of %fieldname% %%i
	  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_plancA.sdat %%i\%%i_planc.tif
	)   
	...
	for %%i in (%tiles%) do (
	 echo now trimming Longitudinal Curvature of %fieldname% %%i
	  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_lcA.sdat %%i\%%i_lc.tif
	)   
	...
	for %%i in (%tiles%) do (
	 echo now trimming Cross Sectional Curvature of %fieldname% %%i
	  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_ccA.sdat %%i\%%i_cc.tif
	)   
	...
	for %%i in (%tiles%) do (
	 echo now Minimum Curvature of %fieldname% %%i
	  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_mcA.sdat %%i\%%i_mc.tif
	)   
	...
	for %%i in (%tiles%) do (
	 echo now trimming Maximum Curvature of %fieldname% %%i
	  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_mxcA.sdat %%i\%%i_mxc.tif
	)   
	...
	for %%i in (%tiles%) do (
	 echo now trimming Total Curvature of %fieldname% %%i
	  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_tcA.sdat %%i\%%i_tc.tif
	)   
  ...
  saga_cmd ta_morphometry 1 -ELEVATION=%%i\%%i_s.sgrd -RESULT=%%i\%%i_ciA.sgrd -METHOD=1 -NEIGHBOURS=1
	...
	for %%i in (%tiles%) do (
	 echo now trimming Convergence Index of %fieldname% %%i
	  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_ciA.sdat %%i\%%i_ci.tif
	)   
  ...
  saga_cmd ta_morphometry 12 -DEM=%%i\%%i_s.sgrd -DAH=%%i\%%i_dahA.sgrd -ALPHA_MAX=225
	...
	for %%i in (%tiles%) do (
	 echo now trimming Diurnal Anisotropic Heating of %fieldname% %%i
	  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_dahA.sdat %%i\%%i_dah.tif
	)   
  ...
  saga_cmd ta_morphometry 28 -DEM=%%i\%%i_s.sgrd -TPI=%%i\%%i_tpiA.sgrd -SCALE_MIN=1 -SCALE_MAX=8 -SCALE_NUM=3
	...
	for %%i in (%tiles%) do (
	 echo now trimming MultiScale Topographic Position Index of %fieldname% %%i
	  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_tpiA.sdat %%i\%%i_tpi.tif
	)   
  ...
  saga_cmd ta_morphometry 8 -DEM=%%i\%%i_s.sgrd -MRVBF=%%i\%%i_mrvbfA.sgrd -MRRTF=%%i\%%i_mrrtfA.sgrd -T_SLOPE=32 
	...
	for %%i in (%tiles%) do (
	 echo now trimming MRVBF of %fieldname% %%i
	  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_mrvbfA.sdat %%i\%%i_mrvbf.tif
	)   
	...
	for %%i in (%tiles%) do (
	 echo now trimming MRRTF of %fieldname% %%i
	  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_mrrtfA.sdat %%i\%%i_mrrtf.tif
	)   
  ...
  saga_cmd ta_morphometry 16 -DEM=%%i\%%i_s.sgrd -TRI=%%i\%%i_triA.sgrd -MODE=1 -RADIUS=10
	...
	for %%i in (%tiles%) do (
	 echo now trimming Terrain Ruggedness Index of %fieldname% %%i
	  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_triA.sdat %%i\%%i_tri.tif
	)   
  ...
  saga_cmd ta_morphometry 21 -DEM=%%i\%%i_s.sgrd -CONVEXITY=%%i\%%i_tscA.sgrd -KERNEL=1 -TYPE=0 -EPSILON=0.0 -SCALE=10 -METHOD=1 -DW_WEIGHTING=3 -DW_BANDWIDTH=0.7
	...
	for %%i in (%tiles%) do (
	 echo now trimming Terrain Surface Convexity of %fieldname% %%i
	  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_tscA.sdat %%i\%%i_tsc.tif
	)   
  ...
  saga_cmd ta_hydrology 15 -DEM=%%i\%%i_s.sgrd -TWI=%%i\%%i_swiA.sgrd -AREA=%%i\%%i_caA.sgrd -AREA_MOD=%%i\%%i_mcaA.sgrd -SLOPE=%%i\%%i_csA.sgrd
	...
	for %%i in (%tiles%) do (
	 echo now trimming Saga wetness index of %fieldname% %%i
	  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_swiA.sdat %%i\%%i_swi.tif
	)   
	...
	for %%i in (%tiles%) do (
	 echo now trimming Catchment Slope of %fieldname% %%i
	  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_csA.sdat %%i\%%i_cs.tif
	)
	...
	for %%i in (%tiles%) do (
	 echo now trimming Modified Catchment Area of %fieldname% %%i
	  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_mcaA.sdat %%i\%%i_mca.tif
	)
  ...
  saga_cmd ta_hydrology 21 -SLOPE=%%i\%%i_slA.sgrd -AREA=%%i\%%i_caA.sgrd -SPI=%%i\%%i_spiA.sgrd
    ...
    for %%i in (%tiles%) do (
	 echo now trimming stream power index of %fieldname% %%i
	  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_spiA.sdat %%i\%%i_spi.tif
	) 
  ...
  saga_cmd ta_hydrology 20 -SLOPE=%%i\%%i_slA.sgrd -AREA=%%i\%%i_caA.sgrd -TWI=%%i\%%i_twiA.sgrd
    ...
    for %%i in (%tiles%) do (
	 echo now trimming topographic wetness index of %fieldname% %%i
	  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_twiA.sdat %%i\%%i_twi.tif
	) 	
		for %%i in (%tiles%) do (	   
		 del %%i\%%i_twiA.mgrd
		 del %%i\%%i_twiA.prj
...
for %%i in (%tiles%) do (
 echo now trimming Slope of %fieldname% %%i
  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_slA.sdat %%i\%%i_sl.tif
) 

for %%i in (%tiles%) do (
 echo now trimming Catchment Area index of %fieldname% %%i
  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_caA.sdat %%i\%%i_ca.tif
)	
  ...
  saga_cmd ta_lighting 5 -DEM=%%i\%%i_s.sdat -POS=%%i\%%i_poA.sgrd -RADIUS=%bufferA% -METHOD=1 -DLEVEL=3.0 -NDIRS=8
	...
	for %%i in (%tiles%) do (
	 echo now trimming Positive Topographic Openness of %fieldname% %%i
	  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_poA.sdat %%i\%%i_po.tif
	)   
  ...
  saga_cmd ta_morphometry 10 -DEM=%%i\%%i_s.sdat -MBI=%%i\%%i_mbiA.sgrd -TSLOPE=15.000000 -TCURVE=0.010000 -THREL=15.000000
	...
	for %%i in (%tiles%) do (
	 echo now trimming Mass Balance Index of %fieldname% %%i
	  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_mbiA.sdat %%i\%%i_mbi.tif
	)   
...
for %%i in (%tiles%) do (
 echo now trimming elevation of %fieldname% %%i
  gdalwarp -cutline %indexB% -cwhere "%fieldname% = '%%i'" -cblend %bufferB% -crop_to_cutline -dstnodata -9999 -tr 10 10 %%i\%%i_s.sdat %%i\%%i_s.tif
	)   
